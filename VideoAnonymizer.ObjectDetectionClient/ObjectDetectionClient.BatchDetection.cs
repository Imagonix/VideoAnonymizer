...
{
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<BatchDetectionResult>> DetectObjectsBatchAsync(
        DetectObjectsBatchRequest body)
    {
        return DetectObjectsBatchAsync(body, System.Threading.CancellationToken.None);
    }

    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<BatchDetectionResult>> DetectObjectsBatchAsync(
        DetectObjectsBatchRequest body,
        System.Threading.CancellationToken cancellationToken)
    {
        ...
        urlBuilder_.Append("detectObjectsBatch");
        ...
        if (status_ == 200)
        {
            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<BatchDetectionResult>>(
                    response_,
                    headers_,
                    cancellationToken)
                .ConfigureAwait(false);
...
public sealed class DetectObjectsBatchRequest
{
    [System.Text.Json.Serialization.JsonPropertyName("frames")]
    public System.Collections.Generic.ICollection<DetectObjectsBatchFrame> Frames { get; set; } =
        new System.Collections.ObjectModel.Collection<DetectObjectsBatchFrame>();
}

public sealed class DetectObjectsBatchFrame
{
...
public sealed class BatchDetectionResult
{
    [System.Text.Json.Serialization.JsonPropertyName("frameIndex")]
    public int FrameIndex { get; set; }
